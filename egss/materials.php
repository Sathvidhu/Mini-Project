                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <button class="btn btn-outline-light bg-white text-body px-4 dropdown-toggle" type="button" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false"><strong>Subjects</strong></button>
                    ...
                    <div class="input-group-append" >
                        <button class="btn btn-outline-light bg-white text-body px-4 dropdown-toggle" type="button" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false"><strong>Type of Material</strong></button>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#">Notes </a>
                            <a class="dropdown-item" href="#">Video Classes</a>
                            <a class="dropdown-item" href="#">Question Paper</a>
                            <a class="dropdown-item" href="#">Mcq</a>
                            <a class="dropdown-item" href="#">Moc Test's</a>
                        </div>
                    </div>
                    <div class="input-group-append">
                        <button class="btn btn-secondary px-4 px-lg-5"><strong>Search</strong></button>
                    </div>
                </div>
            </div>
            </div>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 pb-4">
                    <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="notes.php">
