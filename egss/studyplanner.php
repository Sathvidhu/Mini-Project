...
<body>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-4" id="navbarCollapse">
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="m-0 text-uppercase">"Time is what we want most, but what we use worst."</h1>
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            <div class="mx-auto mb-5" style="width: 100%; max-width: 600px;">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <button class="btn btn-outline-light bg-white text-body px-4 dropdown-toggle" type="button" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">Subjects</button>
                    ...
                    <input type="text" class="form-control border-light" id="chname" name="chname" style="padding: 30px 25px;" placeholder="Chapter Name">
                    <div class="input-group-append">
                        <button class="btn btn-secondary px-4 px-lg-5" id="search" name="search">Search</button>
                    </div>
                </div>
            </div>
        </div>
